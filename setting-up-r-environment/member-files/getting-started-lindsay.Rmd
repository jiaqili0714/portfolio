...
Lab documents will be written in R Markdown. This is an R Markdown document. There are three components of this document that we will pay attention to in this file:
...
> After successfully completing checkpoint 1, commit your code (see instructions in Readme).
