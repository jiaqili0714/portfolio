...
Within a repo, you can make your own Branch.  A branch is a version of your repo which you can change without changing the original files.  Branches are local (on your own device) and remote (on a server).  By making a "commit" to your branch, you save its current state locally.  Its best practice to make many commits as you edit your documents, usually after a discrete section has been completed.  When you "Push" your commits (usually many at once), you are "Pushing" your new code or text onto the remote version of your branch.  When you're in a shared repo, others would then be able to open your branch and see its current state.  In other words, you synced your document with a version of the branch that everyone can see.  

If they already have a version of the branch local to them, however, they need to make sure they are also synced to the remote version. 
